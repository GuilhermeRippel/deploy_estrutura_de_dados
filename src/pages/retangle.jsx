...
function Retangle() {
    ...
    return (
        <div className="w-screen h-screen bg-gray-800 flex flex-col">
            <Header title='Área do Retângulo'/>
            <main className="flex-grow w-full p-2 flex flex-col justify-around items-center">
                <div className="flex flex-col md:flex-row justify-around w-full items-center">
                    <div className="w-full sm:w-3/5 md:w-2/5 lg:w-1/5 xl:w-1/5 flex md:flex-col flex-row gap-5 mb-5 md:mb-0">
                    ...
                    <div className="h-1/2 md:h-auto font-bold text-white text-lg flex flex-col items-center md:items-start">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-52 h-40 bg-transparent border-8 border-gray-950 flex items-center justify-center">Área: {area}</div>
                        </div>
                ...
                <div className="w-full gap-3 flex flex-col items-center text-xl font-bold text-gray-300">
                    ...
                    A área do retângulo é calculada pela fórmula: Área = base X altura
                    <span>Por exemplo, se a base é 4 metros e a altura é 3 metros, a área será: 12</span>
                    </p>
                </div>
            </main>
            <Footer />
